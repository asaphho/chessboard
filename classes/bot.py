...
class Bot:
    ...
    def __init__(self, evaluation_func: Callable[[Position], Dict[str, float]],
                 ...
                 pick_n_threatening: int, fluctuation: float):
    ...
    def choose_move(self, position: Position) -> str:
        return choose_best_move(position, self.evaluation_func, self.quick_evaluation_func, self.breadth, self.aggression, self.fluctuation)
